...
class BTLE_DATA(Packet):
    ...
    fields_desc = [
        ...
        BitField("SN", 0, 1),
        BitField("NESN", 0, 1),
        BitEnumField("LLID", 0, 2, {0: "0=invalid", 1: "continue", 2: "start", 3: "control"}),
...
bind_layers(CtrlPDU, LL_INVALID, optcode=0x88) # BTLE_DATA / CtrlPDU / LL_INVALID
# TODO: more optcodes
