...
Touch screen: pinch/extend to zoom, swipe or two-finger rotate."""
    ...
    def world_trace(self):
        ...
        try:
            ...
            return []
        # Check availability of mongodb_database
        if not conf.geoip_city:
            warning("Cannot import the geolite2 CITY mongodb_database.\n"
        ...
        # Open & read the GeoListIP2 mongodb_database
        try:
            db = geoip2.database.Reader(conf.geoip_city)
        except Exception:
            warning("Cannot open geoip2 mongodb_database at %s", conf.geoip_city)
            return []
    ...
    def graph(self, ASres=conf.AS_resolver, padding=0, **kargs):
        ...
        ASres=AS_resolver_cymru(): use whois.cymru.com whois mongodb_database
