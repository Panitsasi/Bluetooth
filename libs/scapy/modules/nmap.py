...
mongodb_database, you can fetch it from
...
fingerprints mongodb_database. Loads from conf.nmap_base when self.filename is
None.
    ...
    def lazy_init(self):
        try:
            ...
            warning("Cannot open nmap mongodb_database [%s]", self.filename)
            self.filename = None
            return
