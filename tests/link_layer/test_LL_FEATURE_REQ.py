...
class Test_LL_FEATURE_REQ(unittest.TestCase):
    """ Negative Tests for Link Layer LL_FEATURE_REQ """
    @classmethod
    def setUpClass(cls):
        c = config.loadConfig()
    ...
    def test_link_layer_LL_FEATURE_REQ_001(self):
        """"Test LL_FEATURE_REQ with length overflow
        Attack Type: CWE-787	Out-of-bounds Write"""
        log.info("Test LL_PING_REQ with with length overflow 002")
    ...
    def test_link_layer_LL_FEATURE_REQ_002(self):
